...
<head>
    ...
    <link rel="stylesheet" href="{{ asset ('mouseContent.css')}}">
...
<body>
    ...
    <div class="container" style="margin-top: 2%;margin-bottom: 2%;">
                <h1 class="products-heading" style="color: black; font-size: 60px;font-family: 'Macondo', sans-serif;">Mouse: </h1>
                <div class="row" style="margin-left: 10px;">
                    @foreach ($products as $product)
                    <div class="product col col-sm-12 col-md-12 col-lg-5">


                        <div class="product-content"><div class="product-img">
                        ...
                        <div class="product-info">
                            ...
                            <p class="product-price">{{$product->orignalPrice}}</p>
