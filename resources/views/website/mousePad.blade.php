@extends('layouts.navbarMousePad')
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset ('mousepadContent.css')}}">
...
<body>
    ...
    <section><div class="container" style="margin-top: 2%;margin-bottom: 2%;">
                <h1 class="products-heading" style="color: black; font-size: 60px;font-family: 'Macondo', sans-serif;">MousePad: </h1>
        ...
        <div class="product-collection">
            <div class="container">
                <h1 class="products-heading" style="color:black;font-family:'Macondo', sans-serif;">OTHER PRODUCTS:</h1>
                <div class="product-collection-wrapper">
                    <div class="row">
                        <div class="col col-sm-12 col-md-12 col-lg-6">
                            <!-- product col left -->
                            <a href="keyboard">
                                <div class="product-col-left flex" style="float: left;height: 100%;border-radius: 10px;border: 4px solid greenyellow;">
                                    <div class="product-col-content">
                                        <h2 class="sm-title">Gaming Keyboard </h2>
                                        <h2 class="md-title">Keyboard collection </h2>
                                        <p class="text-light">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                            Molestiae consequatur facilis eligendi quibusdam voluptatibus exercitationem
                                            autem
                                            voluptatum, beatae architecto odit, quisquam repellat. Deleniti, architecto ab.
                                        </p>
                        ...
                        <div class="col col-sm-12 col-md-12 col-lg-6">
                            <div class="product-col-right">
                                <a href="headset">
                                    <div class="product-col-r-top flex" style="float: right;height: 50%;border-radius: 10px;border: 4px solid greenyellow;">
                                        <div class="product-col-content">
                                            <h2 class="sm-title"> Gaming Headset </h2>
                                            <h2 class="md-title">Headset collection </h2>
                                            <p class="text-light">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                                Molestiae consequatur facilis eligendi quibusdam voluptatibus exercitationem
                                                autem voluptatum, beatae architecto odit, quisquam repellat. Deleniti,
                                                architecto ab.</p>
                                            <button type="button" class="btn-dark">Shop now</button>
                                        </div>
                                    </div>
                            ...
                            <div class="product-col-bottom"><a href="mouse">
                                    <div class="product-col-r-bottom flex" style="float: right;height: 50%;border-radius: 10px;border: 4px solid greenyellow;">
                                        <div class="product-col-content">
                                            <h2 class="sm-title">Gaming Mouse</h2>
                                            <h2 class="md-title">Mouse collection </h2>
                                            <p class="text-light">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                                Molestiae consequatur facilis eligendi quibusdam voluptatibus exercitationem
                                                autem voluptatum, beatae architecto odit, quisquam repellat. Deleniti,
                                                architecto ab.</p>
                ...
                <div class="row gx-4 gx-lg-5">
                    <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
                        ...
                        <ul style="list-style-type:none;text-align: left;font-size: large;font-family: 'Josefin Sans', sans-serif;" class="listItems">
                            <li><a href="" style="color:navajowhite;margin-left:6%;text-decoration: underline;">Profile></a>
                            </li>

                            <li><a href="" style="color:navajowhite;margin-left:6%;text-decoration: underline;">Login></a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
