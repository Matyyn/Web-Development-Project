...
<head>
    ...
    <link rel="stylesheet" href="{{ asset ('headsetContent.css')}}">
    ...
    <section>
        ...
        <div class="product-items">
            ...
            <div class="container" style="margin-top: 2%;margin-bottom: 2%;">
                <h1 class="products-heading" style="color: black; font-size: 60px;font-family: 'Macondo', sans-serif;">Headset: </h1>
